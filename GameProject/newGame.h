...
public:
	  ...
	  ////////////////////////////////////////////////////////////////
      //Initialize the screen with the levels design
      void level()
      {
		  //creates the level
		  char level[20][40] = 
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	**************************************************/
	  ...
	  {
		  system("cls");
		  cout << "You Helped me! on to the next level!!\n\n";
		  system("PAUSE");
	...
	**************************************************/
	  void runGame(hero& fighter)//runs the exploration phase of the game
	  {
		  ...
		  } while(UserMove != 'Q' && UserMove != 'q' && fighter.showLevel() == 1); //Keep running the program until the user types in a Q or q
